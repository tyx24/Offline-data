...
object Data_cleansing_4 {
  def main(args: Array[String]): Unit = {
    ...
    val ods_Table_URL = "hdfs://bigdata1:8020/user/hive/warehouse/ods_ds_hudi.db/base_region"

    val dwd_Table_URL = "hdfs://bigdata1:8020/user/hive/warehouse/dwd_ds_hudi.db/dim_region"
    ...
    sparkSession.sql(
      ...
      .option(TBL_NAME.key(), "dim_region")
