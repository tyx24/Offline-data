...
object Data_cleansing_2 {
  def main(args: Array[String]): Unit = {
    ...
    val ods_Table_URL = "hdfs://bigdata1:8020/user/hive/warehouse/ods_ds_hudi.db/sku_info"

    val dwd_Table_URL = "hdfs://bigdata1:8020/user/hive/warehouse/dwd_ds_hudi.db/dim_sku_info"
