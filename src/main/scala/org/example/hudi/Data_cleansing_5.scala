...
object Data_cleansing_5 {
  def main(args: Array[String]): Unit = {
    ...
    val ods_Table_URL = "hdfs://bigdata1:8020/user/hive/warehouse/ods_ds_hudi.db/order_info"

    val dwd_Table_URL = "hdfs://bigdata1:8020/user/hive/warehouse/dwd_ds_hudi.db/fact_order_info"
